...
describe('total likes', () => {
  ...
  test('when list five one blog, equals the likes of that', () => {
...
describe('most likes', () => {
  ...
  test('when list zero blog, most likes has', () => {
  ...
  test('when list has five blogs, most likes has', () => {
    const result = listHelper.favoriteBlog(listWithFiveBlog)
    expect(result).toEqual(listWithFiveBlog[2])
  })
})
...
describe('most blogs', () => {
  ...
  test('when list has zero blogs, most blogs has', () => {
  ...
  test('when list has one blog, most blogs has', () => {
  ...
  test('when list has five blogs, most blogs has', () => {
    const result = listHelper.mostBlogs(listWithFiveBlog)
    expect(result).toEqual(fiveBlog)
  })
})
...
describe('author most likes', () => {
  ...
  test('when list has zero blogs, most likes has', () => {
  ...
  test('when list has one blog, most likes has', () => {
